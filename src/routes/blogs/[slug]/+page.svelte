...
<main id="main" class="text-slate-9 00 py-5">
    <!-- {#if data!== null} -->
    ...
    <p
        class="text-gray-400 font-semibold text-justify lg:w-[70%] m-auto lg:bg-yellow-200 lg:p-10 sm:w-[100%] rounded-2xl"
    >
        {data.description}
    </p>
...
<style>
    ...
    :global(th) {
        background-color: rgba(201, 232, 191, 0.6);
