    ...
    <div class="page">
        <div class="cars">
            <div class="car-info">
                ...
                <div>
                    <h4>Car Name</h4><br>
                    <h6>Price - Rs. 8.19 - 14.4 Lakhs*</h6>
                    <h6>Fuel Type - Petrol  / CNG</h6>
                    <h6>Mileage - 19.8 kmpl / 25.51 km/kg</h6>
                    <h6>Transmission - Manual / Automatic</h6>
                    <button>View</button>
                </div>
            </div>
            <div class="car-info">
        ...
        <div class="outer">
            ...
            <div class="picks">
                <h4>Our Tops Picks</h4>
                    <div>
                        <h6>1. Grand Vitara</h6>
                        <img src="" alt="">
                        <a href="">visit</a>
                    </div>
                    <div>
...
<style>
    ...
    .picks div {
        background-color: rgb(136, 134, 139);
